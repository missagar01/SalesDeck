    ...
    <Slide isActive={isActive}>
      ...
      <div className="relative w-full max-w-[1000px] mx-auto mt-[10px] md:mt-[20px] flex items-center justify-center h-[300px] md:h-[360px] overflow-hidden">
        ...
        <div className="relative w-[220px] h-[100px] md:w-[550px] md:h-[240px] scale-[0.48] min-[360px]:scale-[0.55] min-[400px]:scale-[0.65] min-[480px]:scale-[0.75] sm:scale-[0.8] md:scale-[0.7] flex items-center justify-center">
          ...
          {/* ERP Block (z-30) */}
          <div 
            className={`absolute left-0 top-0 w-[110px] h-[100px] md:w-[250px] md:h-[240px] bg-[#2f2f2f] rounded-l-none rounded-r-[60px] md:rounded-r-[120px] z-30 flex items-center justify-center text-white font-disp font-bold text-[11px] md:text-[28px] shadow-[4px_0_15px_rgba(0,0,0,0.3)] transition-all duration-[1000ms] ease-out ${isActive ? 'translate-x-0 opacity-100' : 'translate-x-[-30px] opacity-0'}`}
          ...
          {/* CRM Block (z-20) */}
          <div 
            className={`absolute left-[55px] md:left-[150px] top-0 w-[110px] h-[100px] md:w-[250px] md:h-[240px] bg-[#d32f2f] rounded-l-none rounded-r-[60px] md:rounded-r-[120px] z-20 flex items-center justify-center text-white font-disp font-bold text-[11px] md:text-[28px] shadow-[4px_0_15px_rgba(0,0,0,0.3)] transition-all duration-[1000ms] ease-out ${isActive ? 'translate-x-0 opacity-100' : 'translate-x-[-30px] opacity-0'}`}
          ...
          <div 
            className={`absolute left-[110px] md:left-[300px] top-0 w-[110px] h-[100px] md:w-[250px] md:h-[240px] bg-[#757575] rounded-l-none rounded-r-[60px] md:rounded-r-[120px] z-10 flex items-center justify-center text-white font-disp font-bold text-[9px] md:text-[22px] leading-[1.2] shadow-[4px_0_15px_rgba(0,0,0,0.3)] transition-all duration-[1000ms] ease-out ${isActive ? 'translate-x-0 opacity-100' : 'translate-x-[-30px] opacity-0'}`}
          ...
          <div className={`absolute left-[100%] ml-[8px] md:ml-[30px] top-1/2 -translate-y-1/2 w-max text-left transition-all duration-[1000ms] ease-out ${isActive ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-[-20px]'}`} style={{ transitionDelay: '1200ms' }}>
            ...
            <div className="absolute left-[-10px] md:left-[-30px] top-1/2 -translate-y-1/2 w-[8px] md:w-[20px] h-[1px] md:h-[2px] bg-[#757575]"></div>
          </div>
