...
export default function ThankYouSlide({ isActive }) {
  return (
    <Slide isActive={isActive} center>
      <div className={`flex flex-col items-center w-full text-center ${isActive ? 'animate-slideUp' : 'opacity-0'}`} style={{ animationDelay: '200ms', animationFillMode: 'both' }}>
        ...
        {/* Thank You Box */}
        <div className="border-t-[2px] border-b-[2px] border-[#d32f2f] py-[10px] md:py-[15px] mb-[15px] md:mb-[20px] w-full max-w-[500px] mx-auto">
        ...
        {/* Contact Us */}
        <div className="text-[#d32f2f] font-body text-[16px] md:text-[20px] mb-[8px] md:mb-[12px]">
          -Contact Us
        </div>

        {/* Contact Details */}
        <div className="flex flex-col gap-[10px] md:gap-[12px] font-disp font-bold text-[14px] md:text-[18px] text-[#1a202c] mb-[15px] md:mb-[20px]">
        ...
        {/* Follow Us */}
        <div className="text-[#333] font-body text-[14px] md:text-[16px] mb-[8px] md:mb-[12px]">
          -Follow Us on
        </div>
