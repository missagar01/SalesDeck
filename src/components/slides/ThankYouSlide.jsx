  ...
  return (
    <Slide isActive={isActive} center>
      ...
      <div className={`flex flex-col items-center w-full text-center relative z-10 ${isActive ? 'animate-slideUp' : 'opacity-0'}`} style={{ animationDelay: '200ms', animationFillMode: 'both' }}>
        ...
        {/* Thank You Box */}
        <div className="border-t-2 border-b-2 border-red py-[10px] md:py-[15px] mb-[15px] md:mb-[20px] w-full max-w-[500px] mx-auto">
        ...
        {/* Contact Us */}
        <div className="text-red font-body font-semibold text-[16px] md:text-[20px] mb-[8px] md:mb-[12px] drop-shadow-[0_1.5px_3px_rgba(0,0,0,0.6)]">
          -Contact Us
        </div>
        ...
        <div className="flex flex-col gap-[10px] md:gap-[12px] font-disp font-bold text-[14px] md:text-[18px] text-white mb-[15px] md:mb-[20px] w-full drop-shadow-[0_1.5px_3px_rgba(0,0,0,0.6)]">
          <div className="flex items-center justify-center gap-[10px] w-fit mx-auto">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-[18px] h-[18px] md:w-[20px] md:h-[20px] shrink-0 text-red">
        ...
        <div className="flex items-center justify-center gap-[20px]">
          <a href="#" className="text-white hover:text-red transition-colors drop-shadow-[0_1.5px_3px_rgba(0,0,0,0.6)]">
