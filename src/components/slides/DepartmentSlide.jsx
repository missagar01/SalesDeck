  ...
  const renderButtons = () => {
    if (activeTab === 'maintenance') {
      return (
        <>
          ...
          >
            <span className="w-[6px] h-[6px] md:w-[8px] md:h-[8px] rounded-full bg-current shadow-[0_0_8px_currentColor]"></span>Run a repair
          </button>
          <button 
            className="font-mono text-[11px] md:text-[12.5px] tracking-[.06em] cursor-pointer border border-line bg-panel2 text-ink p-[6px_10px] md:p-[11px_16px] rounded-[10px] transition-[.18s] inline-flex items-center gap-[6px] md:gap-[8px] hover:border-amber hover:text-amber disabled:opacity-40 shrink-0"
    ...
    return (
      <>
        ...
        >
          <span className="w-[6px] h-[6px] md:w-[8px] md:h-[8px] rounded-full bg-current shadow-[0_0_8px_currentColor]"></span>{runLabel}
        </button>
        <button 
          className="font-mono text-[11px] md:text-[12.5px] tracking-[.06em] cursor-pointer border border-line bg-panel2 text-ink p-[6px_10px] md:p-[11px_16px] rounded-[10px] transition-[.18s] inline-flex items-center gap-[6px] md:gap-[8px] hover:border-amber hover:text-amber shrink-0"
          onClick={() => reset()}
    ...
    <Slide isActive={isActive}>
      ...
      <div className="flex flex-col md:flex-row gap-[16px] mt-[30px] md:mt-[50px]">
        ...
        <div className="flex-[2] border border-line bg-panel rounded-[12px] p-[16px] md:p-[20px] h-[180px] md:h-[200px] overflow-hidden flex flex-col relative">
          ...
          <div className="flex-1 overflow-y-auto flex flex-col justify-end">
            <div className="flex flex-col gap-[8px]">
              {logs.map((log, i) => (
                <div key={i} className={`flex gap-[12px] text-[12px] md:text-[14px] font-mono animate-slideIn ${log.isError ? 'text-[#ff4d4d]' : ''}`} style={{ animationDuration: '300ms' }}>
        ...
        <div className="flex-[1] border border-line bg-panel2 rounded-[12px] p-[16px] md:p-[24px] flex flex-col justify-center">
          <div className="text-muted font-mono text-[10px] md:text-[12px] uppercase tracking-[0.1em] mb-[8px]">
          ...
          {status === 'delay' && activeStepIndex >= 1 && (
            <div className="mt-[16px]">
              <span className="inline-block px-[10px] py-[4px] bg-red-soft border border-[#ff4d4d] text-[#ff4d4d] text-[10px] font-mono uppercase tracking-[0.1em] rounded-[4px]">
                TAT Breach
              </span>
            </div>
          )}
